...
//    ));
    ...
    private static TreeMap<String, Book> titleBookMap = new TreeMap<String, Book>();
    private static TreeMap<Integer, Book > yearBookMap = new TreeMap<Integer, Book>();
...
//    }};
    ...
    private void init(String fileName) throws IOException {
        ...
        List<Book> books = bookFileReaderWriter.readFromFile();
        allBooks = books;
        for(Book book: books){
            titleBookMap.put(book.getTitle(), book);
        }
    ...
    public void addNewBook(ProductType productType, String title, String author, String isbn, String publisher, String language, String year, Binding binding, Double price){
        if(titleBookMap.containsKey(title)){
